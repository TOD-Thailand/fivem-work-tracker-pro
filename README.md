...
<head>
    ...
    <title>CUTE TOWN FiveM Work Tracker Pro</title>
    ...
    <style>
        :root {
            --primary-color: #980098; /* สีชมพูหลัก */
            --secondary-color: #360036; /* สีชมพูรอง */
            --accent-color: #FF69B4; /* สีชมพูเน้น */
            ...
            --card-bg: #ffffff;
            --gradient-main: linear-gradient(135deg, #980098 0%, #FF69B4 100%); /* เปลี่ยนเป็นโทนชมพู */
            --gradient-card: linear-gradient(135deg, #FF69B4 0%, #DDA0DD 100%); /* เปลี่ยนเป็นโทนชมพู */
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="analytics-panel">
            <div class="header">
                <h2>📊 CUTE TOWN DASHBOARD AGENCY'S</h2>
            </div>
